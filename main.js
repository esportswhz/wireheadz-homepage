...
var EVENTS = [
  ...
  },
  {
    ...
    desc_de:       'WireHeadZ auf internationalem Parkett: Das Team reiste nach Leipzig und erreichte den 2. Platz beim AAA Esports Championship.',
    desc_en:       'WireHeadZ on the international stage: the team travelled to Leipzig and reached 2nd place at the AAA Esports Championship.',
    desc_ls_de:    'WireHeadZ hat beim AAA Esports Championship mitgemacht. Das Turnier war in Leipzig. Wir sind 2. geworden.',
    desc_ls_en:    'WireHeadZ took part in the AAA Esports Championship. The tournament was in Leipzig. We finished 2nd.',
    modal_desc_de: 'WireHeadZ vertrat die WHZ beim AAA Esports Championship 2025 in Leipzig. Das Team zog ins Finale ein und sicherte sich einen starken 2. Platz – ein Meilenstein für den Hochschul-eSport in Sachsen.',
    modal_desc_en: 'WireHeadZ represented WHZ at the AAA Esports Championship 2025 in Leipzig. The team reached the final and secured a strong 2nd place – a milestone for university eSport in Saxony.',
    highlights_de: ['2. Platz im Finale', 'Internationales Turnier in Leipzig', 'WHZ auf der großen Bühne', 'Meilenstein für sächsischen Hochschul-eSport'],
    highlights_en: ['2nd place in the final', 'International tournament in Leipzig', 'WHZ on the big stage', 'Milestone for Saxon university eSport'],
