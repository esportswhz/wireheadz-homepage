...
var EVENTS = [
  ...
  },
  {
    ...
    location_de:   'Tallinn, Estland',
    location_en:   'Tallinn, Estonia',
    categories:    [{de:'Turnier', en:'Tournament'}, {de:'International', en:'International'}],
    desc_de:       'WireHeadZ auf internationalem Parkett: Das Team reiste nach Tallinn und erreichte den 2. Platz beim AAA Esports Championship.',
    desc_en:       'WireHeadZ on the international stage: the team travelled to Tallinn and reached 2nd place at the AAA Esports Championship.',
    desc_ls_de:    'WireHeadZ hat beim AAA Esports Championship mitgemacht. Das Turnier war in Tallinn, Estland. Wir sind 2. geworden.',
    desc_ls_en:    'WireHeadZ took part in the AAA Esports Championship. The tournament was in Tallinn, Estonia. We finished 2nd.',
    modal_desc_de: 'WireHeadZ vertrat die WHZ beim AAA Esports Championship 2025 in Tallinn, Estland. Das Team zog ins Finale ein und sicherte sich einen starken 2. Platz – ein Meilenstein für den Hochschul-eSport in Sachsen.',
    modal_desc_en: 'WireHeadZ represented WHZ at the AAA Esports Championship 2025 in Tallinn, Estonia. The team reached the final and secured a strong 2nd place – a milestone for university eSport in Saxony.',
    highlights_de: ['2. Platz im Finale', 'Internationales Turnier in Tallinn', 'WHZ auf der großen Bühne', 'Meilenstein für sächsischen Hochschul-eSport'],
    highlights_en: ['2nd place in the final', 'International tournament in Tallinn', 'WHZ on the big stage', 'Milestone for Saxon university eSport'],
